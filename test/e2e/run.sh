...
printf 'ok e2e: fake Nauthilus HTTP/gRPC authority, real server binary, fake IMAP and LMTP backends, DATA/BDAT, TLS, route lookup and observability checks passed\n'
