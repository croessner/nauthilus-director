...
- Build with Go 1.26.8 and `-mod=vendor`.
...
| `GO_IMAGE` | `golang:1.26.8-alpine3.23` | Go build-stage image. |
...
checks for Go 1.26.8, vendored builds, non-root runtime, server-only `scratch`
