...
const (
	...
	// AuditOperationRuntimeAggregateReconcile records a runtime aggregate repair pass.
	AuditOperationRuntimeAggregateReconcile AuditOperation = "runtime_aggregate_reconcile"
...
const (
	...
	auditFieldAggregateMarkers   = "aggregate_markers_removed"
	auditFieldAuthoritative      = "authoritative_conflicts"
	auditFieldBackendIdentifier  = "backend_identifier"
	auditFieldBackendNode        = "backend_node"
	auditFieldBackendPool        = "backend_pool"
	auditFieldCountersChanged    = "counter_fields_changed"
	auditFieldCountersRemoved    = "counter_fields_removed"
	auditFieldControlAction      = "control_action"
	auditFieldDryRun             = "dry_run"
	...
	auditFieldIdleAffinities     = "idle_affinities_added"
	...
	auditFieldScope              = "scope"
	auditFieldScopeCount         = "scope_count"
	auditFieldScannedMarkers     = "scanned_markers"
	auditFieldScannedSessions    = "scanned_sessions"
	auditFieldStatus             = "status"
	auditFieldStaleMarkers       = "stale_markers_removed"
	auditFieldStrategy           = "strategy"
	auditFieldStaleIndexEntries  = "stale_index_entries"
