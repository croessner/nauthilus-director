	...
	return AuthorityConfig{
		...
		Mechanisms: AuthorityMechanismsConfig{
			...
			Bearer: BearerMechanismConfig{
				...
				Validation:    bearerValidationNauthilusIntrospection,
				TokenMaxBytes: 16384,
				Introspection: BearerIntrospectionConfig{
					Enabled:          true,
		...
		OIDC: AuthorityOIDCConfig{
			...
			ClientCredentials: AuthorityOIDCClientCredentialsConfig{
				...
				TokenEndpointAuthMethod:         oidcClientSecretBasic,
				IntrospectionEndpointAuthMethod: oidcClientSecretBasic,
				Scopes: []string{
