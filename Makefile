...
guardrails: docs-check fix vet lint test race e2e build-check
...
.PHONY: all build build-check clean fix vet lint-config lint test race e2e docs-check guardrails poc-test poc-race version
